...
public class CustomerController {
    ...
    @PostMapping(value = {"", "/"})
    public ResponseEntity<ResponseDto> postCustomer(@RequestBody @Valid PostCustomerRequestDto requestBody) {
    ...
    public ResponseEntity<? super GetCustomerListResponseDto> getCustomerList() {
        ResponseEntity<? super GetCustomerListResponseDto> response = customerService.getCustomreList();
        return response;
    }  

    @GetMapping("/{customerNumber}")
    public ResponseEntity<? super GetCustomerResponseDto> getCustomer(@PathVariable Integer customerNumber) {
    ...
    public ResponseEntity<ResponseDto> deleteCustomer(@PathVariable Integer customerNumber, @AuthenticationPrincipal String userId) {
    ...
    public ResponseEntity<ResponseDto> postCareRecord(@RequestBody @Valid PostCareRecordRequestDto requestBody, @PathVariable Integer customerNumber, @AuthenticationPrincipal String userId) {
        Integer usedToolNumber = requestBody.getUsedToolNumber();
        Integer count = requestBody.getCount();
        if ((usedToolNumber != null && count == null) || (usedToolNumber == null && count != null)) return ResponseDto.validationFail();
    ...
    public ResponseEntity<? super GetCareRecordListResponseDto> getCareRecord(@PathVariable Integer customerNumber) {
